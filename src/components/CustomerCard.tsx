                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Button
                            ...
                            onClick={handleSave}
                            disabled={loading}
                            className="bg-white text-slate-900 hover:bg-slate-50 font-semibold shadow-lg border-0 transition-all hover:scale-105 active:scale-95"
                        >
                            {loading ? <Loader2 className="w-4 h-4 animate-spin text-slate-600" /> : <CheckCircle className="w-4 h-4 mr-2 text-indigo-600" />}
                            Kaydet
                        </Button>
                    </div>
                </div>
