                            ...
                            <div className="flex-1 overflow-y-auto p-2 space-y-2">
                                {stockItems.length === 0 && !stockLoading && (
                                    <div className="text-center py-8 text-gray-500">
                                        ...
                                        <button onClick={fetchStock} className="text-indigo-600 text-sm hover:underline mt-2">Listeyi Yükle</button>
                                    </div>
                                )}
                                ...
                                {stockItems
                                    ...
                                    .map(item => (
                                        <div
                                            ...
                                            className="p-3 border rounded-lg hover:bg-indigo-50 hover:border-indigo-200 cursor-pointer transition-all group"
                                        >
