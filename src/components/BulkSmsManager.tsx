            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center bg-gray-50 p-4 rounded-lg border border-gray-200">
                ...
                <div className="flex gap-2 items-center">
                    <button
                        ...
                        className="flex items-center px-3 py-2 rounded-md text-xs font-bold bg-yellow-100 text-yellow-700 hover:bg-yellow-200 border border-yellow-200 transition-colors"
                        title="Veritabanı durumlarını analiz et"
                    >
                        <Search className="w-3 h-3 mr-1" /> Analiz Et
                    </button>
